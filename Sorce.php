...
$bot_id = "1739195468"; // ايدي بوتك

$admmm = "736792574";

$tbbots = "asdhm2"; // بدون @

$API_KEY = "1739195468:AAG29M83cyLFBBUfsMMrAmHUBP0jozWxdvw";
...
$Dev = array("736792574","736792574");// حط ايدي مطور ثاني بدل الاصفار
@$channel = "asd3515";
@$token = API_KEY;
$buyy = "asdhm2";
...
ادخل للقناة لتتعلم اكثر » @asd3515
",
...
'disable_web_page_preview'=>true,
        ...
        'reply_markup'=>json_encode([
          'inline_keyboard'=>[  
                [['text'=>'• اصنع بوت ، لك 🔱','url'=>'https://t.me/asd3515']],
               ]
        ])
    ]);
}
...
'chat_id'=>$chat_id,
'text'=>"
⌁︙مرحبا انا بوت اسمي روزي
⌁︙اختصاصي حماية المجموعات
⌁︙من التفليش والسبام والخخ .. . ،
⌁︙تفعيلي سهل ومجانا فقط قم برفعي ادمن في مجموعتك وارسل امر ↫ تفعيل
⌁︙سيتم رفع الادمنيه والمنشئ تلقائيا
🦁┇[اضافه البوت الى المجموعه](https://telegram.me/Admed7bot?startgroup=start)

🦁┇[اشترك قناه المطور](https://t.me/asd3515)

🦁┇[المطور](http://t.me/asdhm2)
",
'parse_mode'=>'MarkDown', 'disable_web_page_preview'=>true,
  'reply_to_message_id'=>$message->message_id,
]);
...
'parse_mode'=>'MarkDown', 'disable_web_page_preview'=>true,
  ...
  'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"مطور بوت $namebot 👮",'url'=>"t.me/asdhm2"]],
]])
]);
}}}
...
⌁︙تفعيلي سهل ومجانا فقط قم برفعي ادمن في مجموعتك وارسل امر ↫ تفعيل
⌁︙سيتم رفع الادمنيه والمنشئ تلقائيا
🦁┇[اضافه البوت الى المجموعه](https://telegram.me/Mafa3f5e50957BOT?startgroup=start)
...
$asdhm2 = "799273845";//هنا ايديك
$TTK       = $message->message_id;
$Kickmetxt = file_get_contents("kickme.txt");
if ($text =="اطردني" or $text == "ادفرني" or $text == "مغادره" and $from_id != $asdhm2){
...
if ($text =="اطردني" and $from_id == $asdhm2){
 bot("sendMessage",[
 "chat_id"=>$chat_id,
 "text"=>"
• لااستطيع طردك مطوري •
...
••┉┉┉┉┉┉┉┉┉┉┉┉┉•• 
💢❉ قم بمراسله المطور لصنع بوت مدفوع خاص بك › @asdhm2 ✅
📮✣ لصنع بوتك مجاني من مصنع بوتات روكي ‹ @asd3515 › 👨🏽‍💻
",
   'reply_markup'=>json_encode([
    'inline_keyboard'=>[
	[
	['text'=>'','url'=>"https://t.me/admed30bot"]
              ] 
              ],
        ])
            ]);
